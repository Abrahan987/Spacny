...
<body>
    ...
    <div class="login-container">
        ...
        <h1 class="title">API Keys Manager</h1>

        <p class="subtitle">Inicia sesión para gestionar tus API Keys</p>
        ...
        <div class="back-home">
            ...
            <a href="index.php" class="link">← Volver a subir archivos</a>
